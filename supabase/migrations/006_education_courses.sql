...
create table if not exists public.lessons (
  ...
  conteudo    text,      -- texto/markdown content
...
('m1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001', 'Fundamentos da Alimentação Saudável', 'A base para uma relação positiva com a comida', 1),
('m1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000001', 'Montando o Prato Perfeito', 'Proporções, variedade e praticidade', 2),
('m1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000001', 'Planejamento Semanal', 'Como organizar refeições sem estresse', 3);

insert into public.lessons (module_id, titulo, descricao, tipo, video_url, conteudo, duracao_min, ordem) values
('m1000000-0000-0000-0000-000000000001', 'Por que dietas restritivas não funcionam', 'A verdade sobre o efeito sanfona e como sair desse ciclo', 'video', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', null, 8, 1),
('m1000000-0000-0000-0000-000000000001', 'Macronutrientes descomplicados', 'Proteínas, carboidratos e gorduras — o que realmente importa saber', 'markdown',
null,
...
6, 2),
('m1000000-0000-0000-0000-000000000001', 'A importância da hidratação', 'Água, chás e o que conta como hidratação de verdade', 'texto', null,
'Você sabia que a desidratação leve já causa fadiga, dificuldade de concentração e até fome falsa?\n\nMuitas vezes o que sentimos como fome é sede. Antes de beliscar fora de hora, tome um copo d''água e espere 10 minutos.\n\nMeta diária: 35ml por kg de peso. Para 60kg: 2,1 litros.\n\nDicas para beber mais água:\n- Tenha sempre uma garrafinha visível na mesa\n- Adicione limão, hortelã ou pepino para variar\n- Chás naturais contam (sem açúcar)\n- Evite refrigerantes e sucos industrializados',
5, 3),
('m1000000-0000-0000-0000-000000000002', 'O método do prato equilibrado', 'Metade legumes, um quarto proteína, um quarto carboidrato — simples assim', 'video', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', null, 10, 1),
('m1000000-0000-0000-0000-000000000002', 'Substituições inteligentes', 'Trocas que fazem diferença sem abrir mão do sabor', 'markdown', null,
...
7, 2),
('m1000000-0000-0000-0000-000000000003', 'Marmitas da semana em 1 hora', 'O método batch cooking da Josi para semanas organizadas', 'video', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', null, 15, 1),
('m1000000-0000-0000-0000-000000000003', 'Lista de compras estratégica', 'Como montar sua lista para não desperdiçar e economizar', 'markdown', null,
E'# Lista de compras estratégica\n\n## 🥬 Vegetais base (compre sempre)\n- Espinafre, couve, rúcula\n- Brócolis, abobrinha, cenoura\n- Tomate, pepino, cebola, alho\n\n## 🥩 Proteínas\n- Peito de frango (congele em porções)\n- Ovos (duram a semana toda)\n- Atum em lata (pratico para emergências)\n- Leguminosas: feijão, grão-de-bico, lentilha\n\n## 🍚 Carboidratos complexos\n- Batata-doce, inhame\n- Arroz integral\n- Aveia em flocos\n\n## 🥫 Despensa inteligente\n- Azeite de oliva extra virgem\n- Coco ralado sem açúcar\n- Castanhas e nozes\n- Temperos naturais\n\n## 💡 Dica da Josi\nCompre com estômago cheio e lista na mão. Evite os corredores do meio (processados). Fique no perímetro do mercado.',
8, 2);

-- CURSO 2: Mindset de Transformação
insert into public.courses (id, titulo, descricao, categoria, is_premium, ordem) values
...
insert into public.course_modules (id, course_id, titulo, descricao, ordem) values
('m2000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000002', 'A Base Mental', 'Entenda o que está por trás dos seus padrões', 1),
('m2000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000002', 'Construindo Hábitos Duradouros', 'Da vontade para a ação consistente', 2);

insert into public.lessons (module_id, titulo, descricao, tipo, video_url, conteudo, duracao_min, ordem) values
('m2000000-0000-0000-0000-000000000001', 'Por que você sabota seus próprios resultados', 'Os mecanismos inconscientes que nos impedem de avançar', 'video', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', null, 12, 1),
('m2000000-0000-0000-0000-000000000001', 'Identificando crenças limitantes', 'O que você acredita sobre si mesma que te prende', 'markdown', null,
...
insert into public.course_modules (id, course_id, titulo, descricao, ordem) values
('m3000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000003', 'Café da Manhã Poderoso', 'Começos de dia nutritivos e gostosos', 1),
('m3000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000003', 'Almoço e Jantar Sem Culpa', 'Refeições completas e leves', 2);

insert into public.lessons (module_id, titulo, descricao, tipo, video_url, conteudo, duracao_min, ordem, is_premium) values
('m3000000-0000-0000-0000-000000000001', 'Tapioca proteica com ovo e queijo', 'A tapioca perfeita que sustenta de verdade', 'video', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', null, 7, 1, true),
('m3000000-0000-0000-0000-000000000001', 'Vitamina verde da Josi', 'O blend que a Josi toma toda manhã na chácara', 'markdown', null,
...
5, 2, true),
('m3000000-0000-0000-0000-000000000001', 'Panqueca de banana com aveia', 'Zero farinha, zero açúcar, 100% satisfatória', 'markdown', null,
...
6, 3, true),
('m3000000-0000-0000-0000-000000000002', 'Frango desfiado no limão siciliano', 'Simples, rápido e serve para montar vários pratos', 'video', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', null, 12, 1, true),
('m3000000-0000-0000-0000-000000000002', 'Bowl de quinoa com legumes assados', 'Uma refeição completa e bonita', 'markdown', null,
E'# Bowl de Quinoa com Legumes Assados\n\n## 🌾 Ingredientes (2 porções)\n\n**Base:**\n- 1 xícara de quinoa\n- 2 xícaras de água\n- Sal\n\n**Legumes assados:**\n- 1 abobrinha em cubos\n- 1 pimentão vermelho\n- 1/2 cebola roxa\n- 200g de tomate cereja\n- Azeite, sal, orégano\n\n**Para servir:**\n- Homus\n- Rúcula fresca\n- Castanhas do Pará picadas\n- Limão siciliano\n\n## 👩‍🍳 Preparo\n\n**Quinoa:** Lave bem, coloque na panela com a água e o sal. Cozinhe em fogo médio por 15 minutos com a panela tampada.\n\n**Legumes:** Misture com azeite e temperos, espalhe numa assadeira e asse a 200°C por 25 minutos.\n\n**Montagem:** Quinoa na base, legumes por cima, uma colher de homus, rúcula, castanhas e squeeze de limão.',
14, 2, true);
